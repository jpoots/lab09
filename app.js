...
app.get("/show", async (req, res) => {
    ...
    let results = await axios.get(getshow)
    ...
    for (actor of cast){
        console.log(actor)
        let getActor = `https://jbusch.webhosting2.eeecs.qub.ac.uk/tvapi/?actor=${actor.actorid}`
        let actorData = await axios.get(getActor);

        castName.push(actorData.data.actorname);
    }
...
app.post("/create", (req, res) => {
    ...
    let epoint="http://jbusch.webhosting2.eeecs.qub.ac.uk/tvapi/?create&apikey=50788254";
